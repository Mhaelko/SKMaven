...
public class WebDriverEventListenerImplementation implements WebDriverEventListener {
    private static Logger LOG = LogManager.getLogger(WebDriverEventListenerImplementation.class.getName());
    private String screenshotDir;

    public WebDriverEventListenerImplementation (String screenshotDir) {
    ...
    public void beforeFindBy (By by, WebElement element, WebDriver driver) {
        ...
        LOG.debug("Searching for element <{}>  by '{}'", tagName, by);
    }
    ...
    public void afterFindBy (By by, WebElement element, WebDriver driver) {
        ...
        LOG.debug("Found element <{}>", tagName);
    }
